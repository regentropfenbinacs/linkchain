...
#define AllocMinLTK "100000"
#define AllocMinDeposit AllocMinLTK E18
...
void ConstructionCommittee::DepositIn(const tc::Address& address) {
    ...
    TC_RequireWithMsg(amount >= BInt(AllocMinDeposit), "ConstructionCommittee DepositIn amount < " AllocMinLTK "LTK!");
